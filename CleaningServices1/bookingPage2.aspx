<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookingPage2.aspx.cs" Inherits="CleaningServices1.bookingPage2" %>
...
<%--                                                    <span class="form-label">Number Of Bathrooms</span>--%>
                                                    <asp:CheckBox ID="checkboxBathrooms" runat="server" AutoPostBack="True" OnCheckedChanged="checkboxBathrooms_CheckedChanged" Text="Bathrooms" ForeColor="White" class="col-sm-6"/>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td style="width:50%"> <i class="fa-solid fa-bath" style="margin-right: 10px"></i></td>
                                                            <td style="width:50%"><asp:Label ID="lblBathrooms" Text="Bathrooms" runat="server" /></td>
                                                        </tr>
                                                         <tr>
