<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeDetails.aspx.cs" Inherits="CleaningServices1.AdminDashboard.EmployeeDetails" %>
...
>
                    ...
                    <RowStyle HorizontalAlign="Center" />
                                ...
                                <div style="width:100%"> 
            <asp:Button ID="back" runat="server" Text="Back To Employee" PostBackUrl="~/AdminDashboard/Employees.aspx" BackColor="#F3E53D" Font-Names="Times New Roman" Font-Size="17px" ForeColor="black" Height="40px" Width="40%" Font-Underline="False" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" style="margin-left:30%; border-radius:7px"/>
                        </div>
                     </ContentTemplate>
