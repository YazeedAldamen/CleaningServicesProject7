<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminWaiting.aspx.cs" Inherits="CleaningServices1.AdminDashboard.AdminWaiting" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="right">
                <div class="Tilte">
                    <asp:Label ID="Label1" runat="server" Text="Client Requests"></asp:Label> </div>
        ...
        <div class="content">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                      ...
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridTable .table-striped table" EmptyDataText="No Data Found">
                    ...
                    <Columns>                        
                        ...
                        <asp:BoundField DataField="ClientPhone" HeaderText="Phone" />
                        ...
                        <asp:TemplateField HeaderText="Assign">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("BookingID", "assign.aspx?id={0}") %>' Text=" Assign" CssClass="btn btn-warning" ForeColor="White"></asp:HyperLink>
                            </ItemTemplate>
