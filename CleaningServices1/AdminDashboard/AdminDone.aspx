<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDone.aspx.cs" Inherits="CleaningServices1.AdminDashboard.AdminDone" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="right">
                <div class="Tilte">
                    <asp:Label ID="Label1" runat="server" Text="Completed Tasks"></asp:Label> </div>
